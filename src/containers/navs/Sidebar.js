...
class Sidebar extends Component {
  ...
  setSelectedLiActive = (callback) => {
    ...
    if (selectedlink != null) {
      ...
      if (selectedParentNoSubItem != null) {
        ...
        this.setState(
          {
            selectedParentMenu: menuItems(
              role.role === 'superAdmin' || role.role === 'reseller',
            )[0].id,
          },
          callback,
        )
  ...
  getIsHasSubItem = () => {
    ...
    const menuItem = menuItems(
      role.role === 'superAdmin' || role.role === 'reseller',
    ).find((x) => x.id === selectedParentMenu)
    if (menuItem)
  ...
  render() {
    ...
    const { role } = this.props
    console.log('menuItems(true)', menuItems(true))
    return (
      <div
        className="sidebar"
        style={{ marginLeft: '5%', backgroundColor: '#000' }}
      >
...
const mapStateToProps = (state) => {
  return {
    ...
    subHiddenBreakpoint: state.menu.subHiddenBreakpoint,
    menuHiddenBreakpoint: state.menu.menuHiddenBreakpoint,
