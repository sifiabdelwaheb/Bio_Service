...
function About(props) {
  ...
  return (
    <div className={Classes.Container_Contact}>
      ...
      >
        <div className={Classes.about_description_title}>WHO WE ARE</div>
        <div className={Classes.about_description}>
          We're a sales performance agency. We've been helping businesses drive
          revenue with the use of inbound marketing and sales enablement tactics
          since 2012. We're a proud HubSpot Diamond Partner and pride ourselves
          on using the best tools to help our clients succeed. Our team is made
          up of smart and talented people that are passionate about creating
          inbound sales results!
        </div>
        ...
        <div className={Classes.about_description}>
          ...
          Strategy (CSS), has been helping sales organizations turn talent into
          performance for almost 40 years. Unlike other marketing agencies,
          we're obsessed with ROI and we have the experience to deliver inbound
          sales results because we've done it ourselves...
        </div>

        <div className={Classes.about_description}>
          We've been where you are. More than a decade ago, when we needed to
          grow and diversify how we generated new business at CSS, we turned to
          inbound marketing and found huge success after launching our sales
          strategy blog. Once we mastered the art of using thought leadership
          content for lead generation, we launched LeadG2 so we could help
      ...
      <Row style={{ marginLeft: "1%", width: "98%" }}>
        ...
        >
          ...
          <Row className={Classes.about_description}>
            Our Mission is to provide the best customer service: Offering
            solutions and products that are verifiably effective - that is our
            vision.She is our guiding principle on all levels - whether in
            strategic decision making within the management teams or in the
            daily operative work of each of our employees. Our vision always
            pushes us to develop and offer high quality solutions and products
            which can be proven to be effective and efficient in their
            application
          </Row>
        </Col>
      </Row>
