...
module.exports = {
  /* 01.General */
  "general.copyright": "Gogo React © 2018 Tous droits réservés.",
  ...
  "user.status-true": "Oui",
  "user.status-false": "Non",
  /* 03.Menu */
  "menu.app": "Accueil",
  "menu.dashboards": "Tableaux de bord",
  "menu.default": "Défaut",
  "menu.analytics": "Analytique",
  "menu.ecommerce": "Commerce électronique",
  "menu.content": "Contenu",
  "menu.pages": "Pages",
  "menu.users": "Entreprise",
  "menu.packages": "Pack",
  "menu.employee": "Employé",
  "menu.incapacity": "Incapacité",
  "menu.employeedetails": "Détails de l'employé",

  "menu.data-list": "Liste des données",
  "menu.thumb-list": "Liste des miniatures",
  "menu.image-list": "Liste d'images",
  "menu.details": "Détails",
  "menu.search": "Chercher",
  "menu.login": "S'identifier",
  "menu.register": "S'inscrire",
  "menu.forgot-password": "Mot de passe oublié",
  "menu.error": "Erreur",
  "menu.applications": "Applications",
  "menu.todo": "Liste de choses à faire",
  "menu.survey": "Enquête",
  "menu.chat": "Bavarder",
  "menu.ui": "UI",
  "menu.alerts": "Alertes",
  "menu.badges": "Insignes",
  "menu.buttons": "Boutons",
  "menu.cards": "Cartes",
  "menu.carousel": "Carrousel",
  "menu.charts": "Graphiques",
  "menu.collapse": "Effondrer",
  "menu.dropdowns": "Liste déroulante",
  "menu.editors": "Éditeurs",
  "menu.form-layouts": "Disposition des formulaires",
  "menu.form-components": "Composants de formulaire",
  "menu.form-validations": "Validations de formulaire",
  "menu.form-wizard": "Assistant de formulaire",
  "menu.icons": "Icônes",
  "menu.input-groups": "Groupes d'entrées",
  "menu.jumbotron": "Jumbotron",
  "menu.modal": "Modal",
  "menu.navigation": "La navigation",
  "menu.popover-tooltip": "Popover et info-bulle",
  "menu.sortable": "Triable",
  "menu.tables": "les tables",
  "menu.menu": "Menu",
  "menu.subhidden": "Subhidden",
  "menu.hidden": "Caché",
  "menu.visible": "Visible",
  "menu.maps": "Plans",
  "menu.landingpage": "Page de destination",
  "menu.multipage-home": "Accueil multipage",
  "menu.singlepage-home": "Page d'accueil unique",
  "menu.about": "A propos",
  "menu.auth-login": "Connexion d'authentification",
  "menu.auth-register": "Registre d'authentification",
  "menu.reset-password": "réinitialiser le mot de passe",
  "menu.blog": "Blog",
  "menu.blog-list": "Liste des blogs",
  "menu.blog-detail": "Détail du blog",
  ...
  "menu.wizard": "Wizard",
  "menu.dialysis": "Dialyse",
  "menu.department": "Départements",
  ...
  /* 05.Pages */
  "pages.add-new": "AJOUTER UN NOUVEAU",
  "pages.add-new-modal-title": "Ajouter un nouvel élément",
  "pages.display-options": "Option d'affichage",
  "pages.orderby": "Commandé par : ",
  ...
  "survey.edit": "Edit",
  "survey.add-new": "AJOUTER UN NOUVEAU",
  ...
  "dashboards.home": "ACCUEIL",
  "dashboards.services": "SERVICE",
  "dashboards.contact": "CONTACT",
  "dashboards.department": "DÉPARTEMENT",
  "dashboards.about": " A PROPOS",
};
